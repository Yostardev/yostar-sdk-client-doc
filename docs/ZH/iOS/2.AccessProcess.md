...
`libz.tbd`
添加完成后如图：
![](https://github.com/Yostardev/yostarsdk/master/docs/_media/iOS_2.2.2.png)
* 导入资源包成功如图：
![](https://github.com/Yostardev/yostarsdk/master/docs/_media/iOS_2.2.3.png)
* 设置Other Linker Flags
在工程 Target 的 Build Settings ->Linking ->Other Linker Flags 添加“-ObjC”，如下图：
![](https://github.com/Yostardev/yostarsdk/master/docs/_media/iOS_2.2.4.png)
